...
int main(int argc, char** argv){
	...
	ros::Subscriber state_sub = nh.subscribe("/joint_states", 1, Hand_Demo_Warehouse_Onecamera::get_current_states,this);
	ros::Subscriber camera_sub = nh.subscribe("/webcam/image_raw", 1, Hand_Demo_Warehouse_Onecamera::One_camera_callback,this);
	...
	double wrist2_upper_limit = 0.140;
